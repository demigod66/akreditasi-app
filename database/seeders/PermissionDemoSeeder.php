...
class PermissionDemoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // tambah permission
        Permission::create(['name' => 'lihat content standar isi dan standar proses']);
        ...
        Permission::create(['name' => 'lihat content standar penilaian dan standar sarana']);
        ...
        Permission::create(['name' => 'lihat content standar pembiayaan dan standar pengelola']);
        ...
        Permission::create(['name' => 'lihat content standar lulusan dan standar pendidik']);
        ...
        $pic1->givePermissionTo('lihat content standar isi dan standar proses');
        ...
        $pic2->givePermissionTo('lihat content standar penilaian dan standar sarana');
        ...
        $pic3->givePermissionTo('lihat content standar pembiayaan dan standar pengelola');
        ...
        $pic4->givePermissionTo('lihat content standar lulusan dan standar pendidik');
        ...
        $kepsek->givePermissionTo('lihat content standar isi dan standar proses');
        $kepsek->givePermissionTo('lihat content standar penilaian dan standar sarana');
        $kepsek->givePermissionTo('lihat content standar pembiayaan dan standar pengelola');
        $kepsek->givePermissionTo('lihat content standar lulusan dan standar pendidik');
