...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/admin/standar_isi/view', 'StandarIsiController@view');
    Route::get('/show-standar-isi-pdf/{id}', function ($id) {
        $file_standar_isi = StandarIsi::find($id);
        return response()->file(public_path('uploads/standar_isi/' . $file_standar_isi->file));
